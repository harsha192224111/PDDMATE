...
import com.simats.pddmate.databinding.ActivityStudentHomePageBinding
import java.util.*

class SupervisorHomePageActivity : AppCompatActivity() {
    ...
    private fun showPopupMenu(view: View) {
        ...
        popup.menuInflater.inflate(R.menu.supervisor_home_menu, popup.menu)
