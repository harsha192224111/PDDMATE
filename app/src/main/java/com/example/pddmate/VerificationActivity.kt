...
import com.example.pddmate.databinding.ActivityVerificationBinding
import okhttp3.*
...
class VerificationActivity : AppCompatActivity() {
    ...
    private fun sendOtpRequest(email: String) {
        ...
        val request = Request.Builder()
            .url("http://10.213.74.64/pdd_dashboard/forgot_password.php")
            .post(body)
            .build()
    ...
    private fun fetchUserIdThenNavigate(email: String) {
        ...
        val body = json.toString().toRequestBody("application/json; charset=utf-8".toMediaTypeOrNull())
        val request = Request.Builder()
            .url("http://10.213.74.64/pdd_dashboard/get_user_id.php")
            .post(body)
            .build()
